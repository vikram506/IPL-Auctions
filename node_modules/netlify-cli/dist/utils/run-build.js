...
export async function runNetlifyBuild({ command, env = {}, options, settings, timeline, }) {
    ...
    const { configMutations, error: startDevError, success, generatedFunctions, deployEnvVars: deployEnvironment, } = await startDev(devCommand, startDevOptions);
