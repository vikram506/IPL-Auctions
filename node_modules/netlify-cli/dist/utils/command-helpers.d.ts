...
import { type ChalkInstance as ChalkInstancePrimitiveType } from 'chalk';
import type { Option } from 'commander';
import type { TokenLocation } from './types.js';
import type { CachedConfig } from '../lib/build.js';
export declare const chalk: ChalkInstancePrimitiveType;
 ...
 */
export declare const sortOptions: (optionA: Option, optionB: Option) => number;
