...
import { BANG, chalk, logAndThrowError, exit, log, NETLIFY_CYAN, USER_AGENT, logError, } from '../utils/command-helpers.js';
...
process.on('uncaughtException', async (err) => {
    ...
    try {
        if ('code' in err && err.code === 'EADDRINUSE') {
            ...
            logError(`${chalk.red('Netlify CLI has terminated unexpectedly.')}\n\nPlease report this problem with reproduction steps at ${chalk.underline('https://ntl.fyi/cli-error')} including the error details below.\n`);
...
→ For more help with the CLI, visit ${NETLIFY_CYAN(terminalLink(cliDocsEntrypointUrl, cliDocsEntrypointUrl, { fallback: false }))}
