...
class StatsManager {
    ...
    dispose() {
        var _a;
        (_a = this.d) === null || _a === void 0 ? void 0 : _a.call(this);
...
function clearStats(statsName) {
    ...
    if (statsName != null) {
        (_a = nameToProfile.get(statsName)) === null || _a === void 0 ? void 0 : _a.r();
    }
    else {
 ...
 */
function getAvailableName(statsName) {
    let name = statsName;
    let count = 1;
 ...
 */
function getProfileStats(name, profile) {
...
function createMemoizedMethod(fn, cache, forceUpdate) {
    ...
    const memoized = (cache.s === 1
        ? function memoized(...args) {
            ...
            return cache.z(key, fn.apply(this, args)).v;
        }
        : function memoized(...args) {
            const key = cache.k ? cache.k(args) : args;
...
export { clearStats, getStats, isCollectingStats, memoize, startCollectingStats, stopCollectingStats };
